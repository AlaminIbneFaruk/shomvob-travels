    ...
    >
      ...
      <div className="relative h-64 mb-6">
        ...
        <img
          src={stockImages[0]}
          alt={`${name} package 1`}
          className="absolute top-0 left-0 w-2/3 h-48 object-cover rounded-lg transform -rotate-6 
          transition duration-300 group-hover:rotate-0 group-hover:shadow-2xl pt-2 px-2 pb-10 shadow-xl bg-white"
        />
        {/* Second Image */}
        <img
          src={stockImages[1]}
          alt={`${name} package 2`}
          className="absolute top-8 left-1/4 w-2/3 h-48 object-cover rounded-lg transform rotate-6 
          transition duration-300 group-hover:rotate-0 group-hover:shadow-2xl pt-2 px-2 pb-10 shadow-xl bg-white"
        />
        {/* Third Image */}
        <img
          src={stockImages[2]}
          alt={`${name} package 3`}
          className="absolute bottom-0 right-0 w-2/3 h-48 object-cover rounded-lg transform -rotate-3 
          transition duration-300 group-hover:rotate-0 group-hover:shadow-2xl pt-2 px-2 pb-10 shadow-xl bg-white"
        />
      </div>
