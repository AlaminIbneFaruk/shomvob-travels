  ...
  return (
    <div className="hero min-h-screen text-black w-full flex flex-col lg:flex-row items-center mx-auto p-6 bg-opacity-60 bg-sky-200 rounded-lg my-6 relative">
      <div className="p-6 w-full lg:w-1/2 text-center lg:text-left flex flex-col justify-center order-1 lg:order-none 
        absolute lg:relative inset-0 bg-black bg-opacity-50 lg:bg-opacity-0 text-white lg:text-black p-4 sm:p-8">
        ...
        {buttonText && (
          <button className="btn bg-gradient-to-r from-cyan-400 via-blue-500 to-indigo-600 text-white px-6 py-2 rounded-lg mt-4 hover:scale-105 transition-transform">
            {buttonText}
          </button>
        )}
      </div>
